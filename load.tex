...
\caption{Angular velocity of the actuator shaft $\dot{\theta}_a$ for the system with TR (GREEN), Angular velocity of the load shaft $\dot{\theta}_L$ for the system with TR (PURPLE), Angular Velocity of the actuator shaft for the system without TR (RED) due to the torque input.  It is important to note that $\dot{\theta}_a$ and $\dot{\theta}_L$ are $180^o$ out of phase.}
